...
// =================================================================
// All other existing JavaScript functions and event listeners
// =================================================================
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // Minecraft house animation on scroll
  let lastScrollY = window.scrollY;
  const houses = document.querySelectorAll(".minecraft-house");
  ...
  function animateHouses() {
    ...
    houses.forEach((house, index) => {
      // Each house moves at a slightly different rate for a parallax effect
      const speed = 0.05 * (index + 1);
      const translateY = -scrollY * speed;

      // Add a slight rotation based on scroll
      const rotate = scrollDelta * 0.1;

      house.style.transform = `translateY(${translateY}px) rotate(${rotate}deg)`;
    });

    lastScrollY = scrollY;
    requestAnimationFrame(animateHouses);
  }
